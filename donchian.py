...
implement_strategy("output/historical_data.csv", 100000, "output/result/strategy_results.csv","output/result/strategy_results.word") #initial investment of 10000 dollars
